<?php 
if ($_SERVER['HTTPS'] == '') {
  header("Location: https://register.mission-net.org/exhibitors.php"); 
}
...
require_once 'create_exhib_pdf.php';
   ...
   { 
	...
	return $datum;
      ...
      $sql1 = 'INSERT INTO participants SET firstname = ?, lastname = ?, preferred_name = ?, title = ?, street = ?,
		...
		maritalstatus = ?, gender = ?, passport_name = ?, passport_no = ?, passport_dateofissue = ?, passport_dateofexpire = ?,
		nationality = ?, nationalitytext = ?, invitation_letter = ?, emergency_firstname = ?, emergency_lastname = ?, 
		emergency_phone = ?, other_conf= ?, german_skill = ?, english_skill = ?,
	...
	$values['gender'], utf8_decode($values['passportname']), utf8_decode($values['passportno']));
      ...
      $text.= T_("Thank you for registering to be an exhibitor at mission-net 2009, in Oldenburg, Germany. We are excited that you will be a part of this event and we are looking forward to meeting you and many others from all over Europe.");
      $text.= "\n \n";
      $text.= T_("We are anticipating a great time together and we hope that many meaningful conversations will take place at your stand as you share your heart for missions. In addition to that you have the opportunity to enjoy great worship, speakers, and of course the chance to meet like minded people from all over Europe.");
      $text.= "\n \n";
      $text.= T_("If you have questions regarding the exhibition, please get in touch with the contact person from your organisation. They will receive detailed information that they can pass on to you as well as regular updates.");
      $text.= "\n \n";
      $text.= T_("Your registration is only valid as soon as we received your payment. If you are under 18 years old you are also required to send in the PDF form sent with the confirmation e-mail, signed by you and your parents.");
      $text.= " \n";
      $text.= T_("If you are making an individual payment, please pay within 2 weeks after completing your online registration.");
      $text.= " \n";
      $text.= T_("If you are making a group payment, an invoice will be issued to your organisation as soon as all the exhibitors from your organisation have registered. On receipt of payment, we will send you another confirmation e-mail that the money has been received.");
      $text.= "\n \n";
      ...
      $text.= "\n \n";
      $text.= T_("Thanks again for registering for Mission-Net, and we trust that this event will be an exciting new step in your journey in the Christian faith.");
      $text.= "\n \n \n";
      $text.= T_("Many Blessings,");
      $text.= "\n \n";
      $text.= T_("Mission-Net Congress Management Team");
      $text.= "\n \n";
      $text.= T_("Mission-Net 2009 -- Alte Neckarelzer Str. 2 -- D-74821 Mosbach");
      $text.= "\n";
      $text.= $infomailaddress;


      $html = T_("Dear") . " " . $values["firstname"] . "<br><br>\n";
      $html.= T_("Thank you for registering to be an exhibitor at mission-net 2009, in Oldenburg, Germany. We are excited that you will be a part of this event and we are looking forward to meeting you and many others from all over Europe.");
      $html.= "\n<br><br>\n";
      $html.= T_("We are anticipating a great time together and we hope that many meaningful conversations will take place at your stand as you share your heart for missions.  In addition to that you have the opportunity to enjoy great worship, speakers, and of course the chance to meet like minded people from all over Europe.");
      $html.= "\n<br><br>\n";
      $html.= T_("If you have questions regarding the exhibition, please get in touch with the contact person from your organisation. They will receive detailed information that they can pass on to you as well as regular updates.");
      $html.= "\n<br><br>\n";
      $html.= T_("Your registration is only valid as soon as we received your payment. If you are under 18 years old you are also required to send in the PDF form sent with the confirmation e-mail, signed by you and your parents.");
      $html.= "\n<br> ";
      $html.= T_("If you are making an individual payment, please pay within 2 weeks after completing your online registration.");
      $html.= "\n<br> ";
      $html.= T_("If you are making a group payment, an invoice will be issued to your organisation as soon as all the exhibitors from your organisation have registered. On receipt of payment, we will send you another confirmation e-mail that the money has been received.");
      $html.= "\n<br><br>\n";
      $html.= T_("Please ensure that this happens so that we can process your registration as quickly as possible.") . "<br>";
      $html.= "\n<br><br>\n";
      $html.= T_("Please find attached all necessary documents again in the PDF format.") . "<br>";
